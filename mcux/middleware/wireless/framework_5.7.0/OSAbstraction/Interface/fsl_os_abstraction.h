...
/*!
 * @brief Disable interrupts except high-priority ones
 *
 * @param pu8OldIntLevel Variable to hold previous setting
*/
void OSA_InterruptEnableRestricted(uint32_t *pu32OldIntLevel);

/*!
 * @brief Restore interrupts that were previously restricted by a call
 * to OSA_InterruptEnableRestricted
 *
 * @param pu8OldIntLevel Variable holding previous setting
*/
...
/*!
 * @brief This function resets the current time to 0.
*/
